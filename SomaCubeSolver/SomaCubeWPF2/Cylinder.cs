...
namespace SomaCubeWPF2
{
	...
	{
		#region cylinder // http://csharphelper.com/blog/2015/04/draw-smooth-cylinders-using-wpf-and-c/
		// Add a cylinder with smooth sides.
		public static void AddSmoothCylinder(MeshGeometry3D mesh, Point3D end_point, Vector3D axis, double radius, int num_sides)
		{
